...
@SpringBootTest
public class OrderUseCaseDuplicationTest {
    ...
    void orderTest() throws Exception{
        ...
        Assertions.assertThat(itemResponseDto.getQuantity()).isEqualTo(0L);
        Assertions.assertThat(itemStocks.get(0).getQuantity()).isEqualTo(0L);
    }
